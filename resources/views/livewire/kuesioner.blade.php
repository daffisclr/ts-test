                                ...
                                <tr id='p_company' class='tr-quis'>
                                    ...
                                    <td>
                                        <input type='text' required name='p_company' class='inp-f5b'
                                            size='30' maxlength='255'><span class='hl'>(f5b)</span>
                                    </td>
                                </tr>
                                        ...
                                        <table class='table table-striped table-responsive'>
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type='radio' required name='p_company_type'
                                                        class='inp-f11' value='5' id='inp-f11-lainnya'> [5]
                                                    Lainnya, tuliskan:
                                                </td>
                                ...
                                <tr id='p_major' class='tr-quis4'>
                                    ...
                                    <td>
                                        <input type='text' required name='p_major' class='inp-f18d'
                                            value='' maxlength='150' /><span class='hl'>(f18c)</span>
                                    </td>
                                </tr>
                            ...
                            @if ($currentStatus == 1 || $currentStatus == 2)
                                ...
                                <tr id='p_university_company_level' class='tr-quis'>
                                    ...
                                    <td>
                                        <input type='radio' required name='p_university_company_level'
                                            class='inp-f15' value='1'> [1]
                                        Setingkat Lebih Tinggi
                                        <span class='hl'>(f15)</span><br />
                                        <input type='radio' required name='p_university_company_level'
                                            class='inp-f15' value='2'> [2]
                                        Tingkat
                                        yang Sama<br />
                                        <input type='radio' required name='p_university_company_level'
                                            class='inp-f15' value='3'> [3]
                                        Setingkat Lebih
                                        Rendah<br />
                                        <input type='radio' required name='p_university_company_level'
                                            class='inp-f15' value='4'> [4]
                                        Tidak
                                        Perlu Pendidikan
                                        Tinggi<br />
                                    </td>
                                    ...
                                    <td>
                                        <table class='table table-striped table-responsive'>
                                            <tr>
                                                ...
                                                <td> :</td>
                                                <td>
                                                    <input type='radio' required name='p_lecture_method'
                                                        class='inp-f2' value='1'> Sangat
                                            ...
                                            <tr>
                                                ...
                                                <td> :</td>
                                                <td>
                                                    <input type='radio' required name='p_demo_method'
                                                        class='inp-f2' value='1'> Sangat
                                            ...
                                            <tr>
                                                ...
                                                <td> :</td>
                                                <td>
                                                    <input type='radio' required name='p_project_method'
                                                        class='inp-f2' value='1'> Sangat
                                            ...
                                            <tr>
                                                ...
                                                <td> :</td>
                                                <td>
                                                    <input type='radio' required name='p_field_method'
                                                        class='inp-f2' value='1'> Sangat
                                ...
                                <tr id='p_job_hunt_method' class='tr-quis'>
                                    ...
                                    <td>
                                        <input type='checkbox' name='p_job_hunt_method[0]' class='inp-f4'
                                            value='Melalui iklan di koran/majalah, brosur'> Melalui iklan di
                                        koran/majalah,
                                        ...
                                        <input type='checkbox' name='p_job_hunt_method[3]' class='inp-f4'
                                            value='Mencari lewat internet/iklan online/milis'> Mencari lewat
                                        internet/iklan
                                        ...
                                        <input type='checkbox' name='p_job_hunt_method[6]' class='inp-f4'
                                            value='Menghubungi agen tenaga kerja komersial/swasta'> Menghubungi agen
                                        tenaga
                                        ...
                                        <input type='checkbox' name='p_job_hunt_method[8]' class='inp-f4'
                                            value='Menghubungi kantor kemahasiswaan/hubungan alumni'> Menghubungi
                                        kantor
                                        ...
                                        <input type='checkbox' name='p_job_hunt_method[12]' class='inp-f4'
                                            value='Melalui penempatan kerja atau magang'> Melalui penempatan kerja
                                        atau
                                        magang
                                ...
                                <tr id='p_job_hunting_status' class='tr-quis'>
                                    ...
                                    <td>
                                        ...
                                        <input type='radio' required name='p_job_hunting_status' class='inp-f10'
                                            value='Tidak, tapi saya sedang menunggu hasil lamaran kerja'> Tidak, tapi
                                        saya
                                ...
                                <tr id='p_compatibility' class='tr-quis'>
                                    ...
                                    <td>
                                        ...
                                        <input type='checkbox' name='p_compatibility_type[2]' class='inp-f16'
                                            value='Di pekerjaan ini saya memperoleh prospek karir yang baik'> Di
                                        pekerjaan
                                        ini
                                        ...
                                        <input type='checkbox' name='p_compatibility_type[7]' class='inp-f16'
                                            value='Pekerjaan saya saat ini lebih menarik'> Pekerjaan saya saat ini
                                        lebih
                                        menarik
                                        ...
                                        <input type='checkbox' id='inp-f1613a' name='p_compatibility_type[12]'
                                            class='inp-f16' value='Lainnya'>Lainnya:
