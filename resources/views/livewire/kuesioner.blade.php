                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input disabled type="text" value="{{ old('name', Auth::user()->name) }}"
                                    class="form-control" placeholder="Enter first name" wire:model="name">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input disabled type="text" value="{{ old('username', Auth::user()->username) }}"
                                    class="form-control" placeholder="NIM Alumni" wire:model="username">
                                <span class="text-danger">
                                    @error('username')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input disabled type="text" value="{{ old('email', Auth::user()->email) }}"
                                    class="form-control" placeholder="Email Alumni" wire:model="email">
                                <span class="text-danger">
                                    @error('email')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input disabled type="text" value="{{ old('phone', Auth::user()->phone) }}"
                                    class="form-control" placeholder="Nomor Telpon Alumni" wire:model="phone">
                                <span class="text-danger">
                                    @error('phone')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text"
                                    ...
                                    class="form-control" placeholder="Jenis Kelamin" wire:model="jenis_kelamin">
                                <span class="text-danger">
                                    @error('jenis_kelamin')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text" value="{{ old('agama', Auth::user()->Alumni->agama) }}"
                                    class="form-control" placeholder="Agama" wire:model="agama">
                                <span class="text-danger">
                                    @error('agama')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text"
                                    ...
                                    class="form-control" placeholder="Angkatan" wire:model="tahun_masuk">
                                <span class="text-danger">
                                    @error('tahun_masuk')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text"
                                    ...
                                    class="form-control" placeholder="Lulusan" wire:model="tahun_lulus">
                                <span class="text-danger">
                                    @error('tahun_lulus')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text" value="{{ old('prodi', Auth::user()->Alumni->prodi) }}"
                                    class="form-control" placeholder="Program Studi" wire:model="prodi">
                                <span class="text-danger">
                                    @error('prodi')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled type="text"
                                    value="{{ old('jenjang', Auth::user()->Alumni->jenjang) }}" class="form-control"
                                    placeholder="Jenjang" wire:model="jenjang">
                                <span class="text-danger">
                                    @error('jenjang')
                                        {{ $message }}
                                    @enderror
